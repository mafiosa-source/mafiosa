...
export const Route = createFileRoute("/admin/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Administration dashboard for ERP users, roles and activity." },
      { property: "og:title", content: "Admin · Alhakeem Group ERP" },
      { property: "og:description", content: "Manage ERP users, roles, permissions and activity." },
