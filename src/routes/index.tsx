...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "AHG Finance Core · Control Center" },
      { name: "description", content: "Live position of every riyal across wallets, cards and held funds." },
      { property: "og:title", content: "AHG Finance Core · Control Center" },
  ...
  return (
    <AppLayout>
      <header className="mb-6">
        <h1 className="text-[26px] font-semibold tracking-tight text-foreground">AHG Finance Core</h1>
